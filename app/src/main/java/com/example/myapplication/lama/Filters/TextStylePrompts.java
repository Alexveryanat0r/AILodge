...
public class TextStylePrompts {
    ...
    public static StaticPrompt JournalisticDown = new StaticPrompt("You should write in literary and poetic language using aphorisms. Add interesting, rare sentences, copying Tolstoy's style. You describe the hotel, make a brief excerpt with stick to the given style, VERY BRIEFLY AND SUCCINCTLY.");
}
